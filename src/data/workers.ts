...
export const workers: Worker[] = [
  ...
  },
  {
    ...
    bio: "New to the farmers market scene but eager to learn. I have a background in hospitality and I'm looking to build a reputation as a reliable booth helper in the Fort Collins area.",
